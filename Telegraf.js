...
const From = msg.chat.id;
const caption = `
This bot is specially designed to help you download TikTok videos automatically. Just send the URL of the TikTok video you want to download, and this bot will complete the task quickly and quickly`
  ...
  const body = /^https:\/\/.*tiktok\.com\/.+/;
   if (body.test(msg.text)) {
    ...
    try {        
        ...
        await sleep(3000)
        await bot.sendMessage(From, 'Powered by @R3yy7EXP');
    } catch (error) {
